...
//
//
// const routherThingy = express.Router();
//
// ensure.ensureLoggedIn();
// ensure.ensureNotLoggedIn();
//
//
// //routherThingy.get('/user/:id',(res, req, next)+>{...})
// routherThingy.get('/profile/edit',
...
// });
// routherThingy.post('profile/edit',
// ensure.ensureLoggedIn('/login'),
// (req, res, next) =>{
//   req.user.name =
// })
